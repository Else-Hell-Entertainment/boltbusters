...
{
    public partial class Deprecated_EnemyGroupCannonBotSurroundPlayer : Node3D, IEnemyGroup
    {
        ...
        public void RegisterBot(EnemyCannonBot bot)
        {
            ...
            {
                this.LogError("Invalid attempt to register CannonBot to SurroundPlayer Group");
            }
        }
